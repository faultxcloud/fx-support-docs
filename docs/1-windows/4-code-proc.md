...
| Code | Arti |
|:---|:---|
|`K`|Unlocked multiplier (Cocok untuk yang ingin overclock)|
...
*sources: [Intel](https://www.intel.co.id/content/www/id/id/processors/processor-numbers.html)*
{: .fs-2 }