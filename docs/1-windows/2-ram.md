---
title: Spesifikasi RAM
parent: Windows
nav_order: 2
layout: default
---

# Cek spesifikasi RAM Laptop/PC  

Berikut cara untuk melihat spesifikasi RAM pada Laptop/PC
dengan melihat **TAB Memory** & **SPD** menggunakan software **CPU-Z**

Silakan terlebih dahulu download software yang bernama CPU-Z di Laptop atau PC kamu:  
<span class="fs-3">
...
<span class="fs-3">
[<img src="{{ '/assets/images/icons/whatsapp.svg' | relative_url }}" width="16" style="vertical-align:middle;"> FaultX.Repair](https://wa.me/6289676665503){: .btn }
</span>